	...
	<div class="container">
			...
			<div class="product-view clearfix">
				...
				<div class="product-info pull-left">
					<div class="row name"><h3>제품명</h3></div>
					<div class="row price underline">
						<div class="pull-left"><h4>가격</h4></div>
					...
					<p>제품에 대한 설명써주세요. 제품에 대한 설명써주세요. 제품에 대한 설명써주세요. 제품에 대한 설명써주세요. 제품에 대한 설명써주세요. 제품에 대한 설명써주세요. 
					</p>
			...
			<div class="row underline">
				...
				<div class="col-sm-2 col-md-2 height"><div class="height-center"><a href="#">후기의 제목</a></div></div>
